...
public abstract class ModelLittleMaidBase<T extends LittleMaidBaseEntity> extends ModelMultiBase<T> {
    ...
    public LayerDefinition createBodyLayer(float size) {
        ...
        PartDefinition left_arm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(48, 0).addBox(1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(size)), PartPose.offset(2.0F, -14.0F, 0.0F));
        ...
        PartDefinition right_arm = root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(48, 0).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(size)), PartPose.offset(-3.0F, -14.0F, 0.0F));
