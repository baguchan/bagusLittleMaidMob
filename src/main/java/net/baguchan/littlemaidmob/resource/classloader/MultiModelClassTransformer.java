package net.baguchan.littlemaidmob.resource.classloader;
...
public class MultiModelClassTransformer {
    ...
    private static final String PACKAGE_STRING = "net/baguchan/littlemaidmob/maidmodel/";
                    ...
                    if (shouldRemove(fANode.owner)) {
                        ...
                        if (GL_REPLACE_MODEL_RENDERER_SET.contains(fANode.name + fANode.desc)) {
                            mNode.instructions.set(fANode, new MethodInsnNode(fANode.getOpcode(),
                                    "net/baguchan/littlemaidmob/maidmodel/compat/GLCompat",
                                    fANode.name,
                                    fANode.desc));
