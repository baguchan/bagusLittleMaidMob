package net.baguchan.littlemaidmob.resource.loader;
...
public class LMMultiModelLoader implements LMLoader {
    ...
    public void load(String path, Path folderPath, InputStream inputStream, boolean isArchive) {
        ...
        try {
            ...
            LittleMaidMod.LOGGER.error("読み込めませんでした。古いモデルの可能性があります : " + path);
            if (LittleMaidConfig.isDebugMode) e.printStackTrace();
        }
    }
