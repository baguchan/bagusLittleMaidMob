package net.baguchan.bagus_littlemaidmob.resource.classloader;
...
public class MultiModelClassTransformer {
    ...
    private static final String PACKAGE_STRING = "net/baguchan/bagus_littlemaidmob/maidmodel/";

    private static final Map<String, String> CODE_REPLACE_MAP = new Object2ObjectOpenHashMap<String, String>() {
        {
            //ローダーを一から書きなおしたので、未使用
            /*//未使用っぽいのはコメントアウト
            ...
            put("mmmlibx/lib/MMM_EntityCaps", "net/baguchan/littlemaidmob/maidmodel/EntityCaps");
            put("littleMaidMobX/EntityCaps", "net/baguchan/littlemaidmob/maidmodel/EntityCaps");
            put("net/blacklab/lmr/util/EntityCaps", "net/baguchan/littlemaidmob/maidmodel/EntityCaps");
            put("net/blacklab/lmr/util/EntityCapsLiving", "net/baguchan/littlemaidmob/maidmodel/EntityCaps");
            ...
            put("net/blacklab/lmr/entity/EntityLittleMaid", "net/baguchan/littlemaidmob/entity/EntityLittleMaid");
            ...
            //NM
            put("net/blacklab/lmr/entity/littlemaid/EntityLittleMaid", "net/baguchan/littlemaidmob/entity/EntityLittleMaid");
                    ...
                    if (shouldRemove(fANode.owner)) {
                        ...
                        if (GL_REPLACE_MODEL_RENDERER_SET.contains(fANode.name + fANode.desc)) {
                            mNode.instructions.set(fANode, new MethodInsnNode(fANode.getOpcode(),
                                    "net/baguchan/bagus_littlemaidmob/maidmodel/compat/GLCompat",
                                    fANode.name,
                                    fANode.desc));
